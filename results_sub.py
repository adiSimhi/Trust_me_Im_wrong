...
class case_study:
    ...
    def strong_chock_examples(self, train_hall, train_factual, test_hall, test_factual):
        ...
        print(
            f"len strong CHOKE examples: {len(strong_chock_examples)} {len(all_chock_examples)=} {len(test_hall)=} {len(test_factual)=}")
    ...
    def mitigation_all_based(self, root_path):
            ...
            for mitigation in mitigations:
                ...
                if "certainty_prob_entropy" in mitigation:
                    ...
                    results[settings][dataset][model_name][mitigation] = {"accuracy": acc, 'hall_acc': hall_acc,
                                                                          "chk": chock_score,
                                                                          "chk-f": all_chock_score,
                                                                          "abstain_fact": abstain_fact,
                                                                          "abstain_hall": abstain_hall,
                                                                          "abstain_chk-f": abstain_chock_all,
                                                                          "abstain_chk": abstain_chock_strong,"auroc": auroc }
                ...
                if "prompt_abstain" in mitigation:
                    if "Instruct" in model_name or "-it" in model_name:
                        ...
                        results[settings][dataset][model_name][mitigation] = {"accuracy": acc, 'hall_acc': hall_acc,
                                                                              ...
                                                                              "abstain_hall": abstain_hall,
                                                                              "abstain_chk-f": abstain_chock_all,
                                                                              "abstain_chk": abstain_chock_strong}
                    continue
                ...
                if "temp_generations" in mitigation:
                    ...
                    results[settings][dataset][model_name][mitigation] = {"accuracy": accuracy,
                                                                          ...
                                                                          "chk": accuracy_chock,
                                                                          "chk-f": accuracy_chock_all,
                                                                          "abstain_fact": factual_correct,
                                                                          "abstain_hall": hall_correct,
                                                                          "abstain_chk-f": chock_all_correct,
                                                                          "abstain_chk": chock_strong_correct,
        ...
        print(results) # results dictionary contain the final results for each setting, dataset, model and mitigation. The results are accuracy, hall_acc, chk, chk-f, abstain_fact, abstain_hall, abstain_chk-f, abstain_chk
